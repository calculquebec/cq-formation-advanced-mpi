...
subroutine update(aold,anew)
  ...
  call MPI_Sendrecv(aold(1,1), bx, MPI_DOUBLE_PRECISION, north, 9, &
       aold(1,by+1), bx, MPI_DOUBLE_PRECISION, south, 9, comm, MPI_STATUS_IGNORE)
  call MPI_Sendrecv(aold(1,by), bx, MPI_DOUBLE_PRECISION, south, 9, &
       aold(1,0), bx, MPI_DOUBLE_PRECISION, north, 9, comm, MPI_STATUS_IGNORE)
  call MPI_Sendrecv(sbufeast, by, MPI_DOUBLE_PRECISION, east, 9, &
       rbufwest, by, MPI_DOUBLE_PRECISION, west, 9, comm, MPI_STATUS_IGNORE)
  call MPI_Sendrecv(sbufwest, by, MPI_DOUBLE_PRECISION, west, 9, &
       rbufeast, by, MPI_DOUBLE_PRECISION, east, 9, comm, MPI_STATUS_IGNORE)

...
subroutine update(aold,anew)
  ...
  call MPI_Isend(aold(1,1), 1, north_south_type, north, 9, comm, reqs(1))
  call MPI_Isend(aold(1,by), 1, north_south_type, south, 9, comm, reqs(2))
  call MPI_Isend(aold(bx,1), 1, east_west_type, east, 9, comm, reqs(3))
  call MPI_Isend(aold(1,1), 1, east_west_type, west, 9, comm, reqs(4))
  call MPI_Irecv(aold(1,0), 1, north_south_type, north, 9, comm, reqs(5))
  call MPI_Irecv(aold(1,by+1), 1, north_south_type, south, 9, comm, reqs(6))
  call MPI_Irecv(aold(bx+1,1), 1, east_west_type, east, 9, comm, reqs(7))
  call MPI_Irecv(aold(0,1), 1, east_west_type, west, 9, comm, reqs(8))
